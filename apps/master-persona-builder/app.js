...
const I18N = {
  en: {
    page_title: "World Author Persona Builder",
    lang_button: "繁中",
    eyebrow: "Digital Lineage Studio",
    hero_title: "World Author Persona Builder",
    ...
    desc_core: "Define author identity and metadata for both Eastern and Western literary personas.",
    ...
    label_dynasty: "Era / Period",
    label_school: "Tradition / Movement",
    label_context: "Historical-Cultural Context",
    ...
    placeholder_name: "William Shakespeare",
    placeholder_description: "High-fidelity literary persona",
    placeholder_display_name: "Shakespeare",
    placeholder_dynasty: "Elizabethan England",
    placeholder_school: "English Renaissance Drama",
  ...
  "zh-Hant": {
    page_title: "世界文豪人格生成器",
    lang_button: "EN",
    eyebrow: "數位文脈工坊",
    hero_title: "世界文豪人格生成器",
    ...
    output_wiki: "wiki.md",
    placeholder_slug: "han-yu",
    placeholder_name: "莎士比亞",
    placeholder_description: "高擬真文學人格",
    placeholder_display_name: "莎士比亞",
    placeholder_dynasty: "伊莉莎白時代",
    placeholder_school: "英國文藝復興戲劇",
